...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><i class="fa fa-inbox"></i>&nbsp;&nbsp;PugaTech</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <a href="./index.php?view=soporte"><span class="glyphicon glyphicon-flag"></span>&nbsp;&nbsp;Soporte técnico</a>
                        ...
                        <li>
                        <a href="./index.php?view=registro"><span class="glyphicon glyphicon-user"></span> &nbsp;Alta Usuarios</a>
                        </li>
                        <li>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center text-primary" id="myModalLabel">Bienvenido a PugaTech</h4>
            </div>
