<?php
    if(isset($_POST['user_reg']) && isset($_POST['clave_reg']) && isset($_POST['nom_complete_reg'])){
        ...
        $asunto="Registro de cuenta en Pugatech";
        $cabecera="From: PugaTechCorp<15443@virtual.utsc.edu.com>";
        $mensaje_mail="Hola ".$nombre_reg.", Los datos de cuenta son los siguientes:\nNombre Completo: ".$nombre_reg."\nNombre de usuario: ".$user_reg."\nClave: ".$clave_reg2."\nEmail: ".$email_reg."\n";
        ...
        if(MysqlQuery::Guardar("cliente", "nombre_completo, nombre_usuario, email_cliente, clave", "'$nombre_reg', '$user_reg', '$email_reg', '$clave_reg'")){
            ...
            echo '
                <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <h4 class="text-center">ALTA EXITOSA</h4>
                    <p class="text-center">
            ...
            echo '
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        Error en el alta: Por favor intente nuevamente.
                    </p>
                </div>
            '; 
        }
  ...
  <div class="row">
    <div class="col-sm-8">
      <div class="panel panel-success">
        <div class="panel-heading text-center"><strong>Alta Usuarios</strong></div>
    ...
    <div class="col-sm-4 text-center hidden-xs">
      <img src="img/add_user.png" class="img-responsive" alt="Image">
    </div>
